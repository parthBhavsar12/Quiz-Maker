...
<body>
    <nav class="container">
        <a href="homepage.php" title="Go on Admin Home Page"><p class="logo"><img src="../Attachments/light_logo.png">QUIZMAKER<br>ADMIN PANEL</img></p></a>
        <ul class="login-nav">
            <li class="nav-item">
                <?php
    ...
    <header>
        <div class="mobile-navigation">
            ...
            <ul>
                <?php
                    if(!isset($_SESSION['admin'])){
                        echo '<li title="Get Logged In"><a href="index.php">Log In</a></li>';
                    }
                    else{
                        echo '<li title="Get Logged Out"><a href="index.php?action=logOut">Log Out</a></li>';
                    }
                ?>
            </ul>
        </div>
    ...
    <main>
        <table>
            <tr><th>You can perform following operations</th></tr>
            <tr><td><a href="admin_check_feedbacks.php" title="CHECK FEEDBACKS">CHECK FEEDBACKS</a></td></tr>
            <tr><td><a href="admin_check_contacts.php" title="CHECK CONTACTS">CHECK CONTACTS</a></td></tr>
            <tr><td><a href="admin_check_database.php" title="CHECK DATABASE">CHECK DATABASE</a></td></tr>
            <tr><td><a href="admin_block.php" title="BLOCK/UNBLOCK USER">BLOCK / UNBLOCK USER</a></td></tr>
        </table>
    </main>  
